#ifndef __VORTEX_VADD_VORTEX_VADD_HH__
#define __VORTEX_VADD_VORTEX_VADD_HH__

#include "dev/io_device.hh"
#include "params/VortexVADD.hh"
...
namespace gem5
{
struct VortexVADDParams;

class VortexVADD : public PioDevice
{
    public:
        VortexVADD(const VortexVADDParams &p);
