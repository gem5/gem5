    ...
    namespace prefetch
    {
        ...
        void IMP::handleIndexAccess(const PrefetchInfo& pfi)
        {
            ...
            if (pfi.hasData()) {
                 ...
                 * the last observed index from the IPD_table. This is beacuse
                 * the subsequent miss would NOT correspond to the stored
        ...
        {
            /*
             * We need the IP to index the tables. If IP is not available,
            ...
            /*
             * Check if this access is a stream access before adding it to the
                ...
                const PrefetchInfo& pfi)
        {
             ...
             * generated by the indirect table
             */
            if (index_value) {
                ...
                const CacheAccessor &cache)
        {
            ...
            /*
             * Insert the pending prefetches with lower priority. These
             * prefetches are generated in the notifyFill function. Please
             * refer to the comments in the header file for more information
             * about these prefetches
             */
        ...
        void IMP::notifyFill(const CacheAccessProbeArg &arg)
        {
             ...
             * cast the address to block address explicitly
             */
