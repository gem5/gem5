/**
 * @file
 * Declaration of a prime displacement indexing policy.
 */
...
#include "params/PrimeDisplacement.hh"

class ReplaceableEntry;

class PrimeDisplacement : public BaseIndexingPolicy
{
  private:
  ...
  public:
    /** Convenience typedef. */
     typedef PrimeDisplacementParams Params;

    /**
     * Construct and initialize this policy.
     */
    PrimeDisplacement(const Params *p);
...
#endif //__MEM_CACHE_INDEXING_POLICIES_PRIME_DISPLACEMENT_HH__
