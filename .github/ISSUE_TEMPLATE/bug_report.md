...
If writing code, or a terminal command, use code blocks. Either an inline code block, `cmake --preset opt-all -B build/ALL && ninja -C build/ALL` (enclosed in two '`') or a multi-line codeblock:
