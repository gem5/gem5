...
if args.binary == "./ece_562_benchmarks/arm/benchmarks/queens":
    print("queens")
    process.cmd = [args.binary, 27]
elif args.binary == "./ece_562_benchmarks/arm/benchmarks/sha":
    print("SHA")
    process.cmd = [args.binary, "/home/jihernandez9513/git/gem5/benchmarks/sha-src/input_small.asc"]
elif args.binary == "./ece_562_benchmarks/arm/benchmarks/BFS":
    print("BFS")
