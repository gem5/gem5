...
if args.binary == "./ece_562_benchmarks/riscv/benchmarks/queens":
    process.cmd = [args.binary, 27]
elif args.binary == "./ece_562_benchmarks/riscv/benchmarks/sha":
    process.cmd = [args.binary, "/home/jihernandez9513/git/gem5/benchmarks/sha-src/input_small.asc"]
elif args.binary == "./ece_562_benchmarks/riscv/benchmarks/BFS":
