...
def gen_core(tag, i):
    ...
    def gen_itlb():
        with tag('component', id = 'system.core' + str(i) + '.itlb', name = 'itlb', type = 'InstructionTLB'):
            ...
            with tag('param', name = 'nbanks', value = '1'):
                pass
            with tag('stat', name = 'total_accesses', value = '50'): # TODO
                pass
            with tag('stat', name = 'total_misses', value = '0'): # TODO
                pass
    ...
    def gen_l1i():
        with tag('component', id = 'system.core' + str(i) + '.icache', name = 'Instruction Cache', type = 'CacheUnit'):
            ...
            with tag('param', name = 'size', value = config_tree.execute('$.system.cpu[' + str(i) + '].icache.size')):
                pass
            with tag('param', name = 'block_size', value = config_tree.execute('$.system.cpu[' + str(i) + '].icache.tags.block_size')):
                pass
            with tag('param', name = 'assoc', value = config_tree.execute('$.system.cpu[' + str(i) + '].icache.assoc')):
                pass
            with tag('param', name = 'num_banks', value = '1'):
                pass
            with tag('param', name = 'latency', value = config_tree.execute('$.system.cpu[' + str(i) + '].icache.hit_latency')):
                pass
            with tag('param', name = 'throughput', value = '3'):
                pass
            ...
            with tag('param', name = 'pure_ram', value = '0'):
                pass
            with tag('stat', name = 'read_accesses', value = '50'): # TODO
                pass
            with tag('stat', name = 'read_misses', value = '12'): # TODO
                pass
    ...
    def gen_dtlb():
        with tag('component', id = 'system.core' + str(i) + '.dtlb', name = 'dtlb', type = 'DataTLB'):
            ...
            with tag('param', name = 'nbanks', value = '1'):
                pass
            with tag('stat', name = 'read_accesses', value = '65'): # TODO
                pass
            with tag('stat', name = 'read_misses', value = '0'): # TODO
                pass
            with tag('stat', name = 'conflicts', value = '0'): # TODO
                pass
    ...
    def gen_l1d():
        with tag('component', id = 'system.core' + str(i) + '.dcache', name = 'Data Cache', type = 'CacheUnit'):
            ...
            with tag('param', name = 'size', value  = config_tree.execute('$.system.cpu[' + str(i) + '].dcache.size')):
                pass
            with tag('param', name = 'block_size', value = config_tree.execute('$.system.cpu[' + str(i) + '].dcache.tags.block_size')):
                pass
            with tag('param', name = 'assoc', value = config_tree.execute('$.system.cpu[' + str(i) + '].dcache.assoc')):
                pass
            with tag('param', name = 'num_banks', value = '1'):
                pass
            with tag('param', name = 'latency', value = config_tree.execute('$.system.cpu[' + str(i) + '].dcache.hit_latency')):
                pass
            with tag('param', name = 'throughput', value = '3'):
                pass
            with tag('param', name = 'miss_buffer_size', value = '2'):
            ...
            with tag('stat', name = 'read_accesses', value = '50'): # TODO
                pass
            with tag('stat', name = 'write_accesses', value = '15'): # TODO
                pass
            with tag('stat', name = 'read_misses', value = '12'): # TODO
                pass
            with tag('stat', name = 'write_misses', value = '3'): # TODO
                pass
            with tag('stat', name = 'conflicts', value = '1'): # TODO
                pass
            with tag('stat', name = 'duty_cycle', value = '1'): # TODO
    ...
    with tag('component', id = 'system.core' + str(i), name = 'core' + str(i), type = 'Core'):
        ...
        with tag('param', name = 'instruction_buffer_tag_width', value = '0'):
            pass
        with tag('stat', name = 'total_instructions', value = '100'): # TODO
            pass
        with tag('stat', name = 'int_instructions', value = '80'): # TODO
            pass
        with tag('stat', name = 'fp_instructions', value = '20'): # TODO
            pass
        with tag('stat', name = 'branch_instructions', value = '25'): # TODO
            pass
        with tag('stat', name = 'branch_mispredictions', value = '2'): # TODO
            pass
        with tag('stat', name = 'load_instructions', value = '50'): # TODO
            pass
        with tag('stat', name = 'store_instructions', value = '15'): # TODO
            pass
        with tag('stat', name = 'committed_instructions', value = '100'): # TODO
            pass
        with tag('stat', name = 'committed_int_instructions', value = '80'): # TODO
            pass
        with tag('stat', name = 'committed_fp_instructions', value = '20'): # TODO
            pass
        with tag('stat', name = 'pipeline_duty_cycle', value = '1'): # TODO
            pass
        with tag('stat', name = 'total_cycles', value = '150'): # TODO
            pass
        ...
        with tag('stat', name = 'float_regfile_writes', value = '20'): # TODO
            pass
        with tag('stat', name = 'function_calls', value = '0'): # TODO
            pass
        with tag('stat', name = 'context_switches', value = '0'): # TODO
            pass
        with tag('stat', name = 'ialu_accesses', value = '70'): # TODO
            pass
        with tag('stat', name = 'fpu_accesses', value = '20'): # TODO
            pass
...
def gen_l2(tag):
    with tag('component', id = 'system.L20', name = 'L2 Cache', type = 'CacheUnit'):
        with tag('param', name = 'level', value = '2'):
            pass
        with tag('param', name = 'size', value  = config_tree.execute('$.system.l2.size')):
            pass
        with tag('param', name = 'block_size', value = config_tree.execute('$.system.l2.tags.block_size')):
            pass
        with tag('param', name = 'assoc', value = config_tree.execute('$.system.l2.assoc')):
            pass
        with tag('param', name = 'num_banks', value = '1'):
            pass
        with tag('param', name = 'latency', value = config_tree.execute('$.system.l2.hit_latency')):
            pass
        with tag('param', name = 'throughput', value = '3'):
            pass
        with tag('param', name = 'miss_buffer_size', value = '2'):
...
def gen_system(tag):
    ...
    with tag('param', name = 'broadcast_addr_din_over_ver_htrees', value = '0'):
        pass
    with tag('stat', name = 'total_cycles', value = '100'): # TODO
        pass
